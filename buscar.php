	...
	<body>
        ...
        <?php
			if ($_SERVER["REQUEST_METHOD"] == "POST") {	
				...
				if ($matricula!="") {
					$sql = "SELECT MATRICULA, NOME, ORIENTADOR, ESCOLA FROM alunos where MATRICULA = '$matricula'"; 
				} else if ($nome!=""){
					$sql = "SELECT MATRICULA, NOME, ORIENTADOR, ESCOLA FROM alunos where NOME = '$nome'"; 
					} else if ($escola!=""){
						$sql = "SELECT MATRICULA, NOME, ORIENTADOR, ESCOLA FROM alunos where ESCOLA = '$escola'"; 
						} else {
							$sql = "SELECT MATRICULA, NOME, ORIENTADOR, ESCOLA FROM alunos where ORIENTADOR = '$orientador'"; 
						}                
